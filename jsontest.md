...
- **platform** (optional, default: `web`): `?platform=web` hoặc `?platform=mobile`
    - **Web Frontend**: `https://be-event-mng-v3-production.up.railway.app/bookings/checkout?paymentMethod=PAYOS`
    - **Mobile App**: `https://be-event-mng-v3-production.up.railway.app/bookings/checkout?paymentMethod=PAYOS&platform=mobile` ⭐ **PHẢI GỬI platform=mobile**
...
- 🔒 Yêu cầu token
- **platform** (optional, default: `web`): `?platform=web` hoặc `?platform=mobile`
    - **Mobile App**: `https://be-event-mng-v3-production.up.railway.app/bookings/checkout-selected?paymentMethod=PAYOS&platform=mobile` ⭐ **PHẢI GỬI platform=mobile**
